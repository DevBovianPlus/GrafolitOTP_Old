            ...
            <div class="row2" style="align-items: center;">
                ...
                <div class="col-xs-8 no-padding-left">
                    <dx:ASPxGridLookup ID="ASPxGridLookupDobavitelj" runat="server" ClientInstanceName="lookUpDobavitelj"
                        ...
                        OnLoad="ASPxGridLookupLoad_WidthSmall" OnDataBinding="ASPxGridLookupDobavitelj_DataBinding">
                        <ClearButton DisplayMode="OnHover" />
                        <ClientSideEvents DropDown="function(s,e){s.GetGridView().GetAutoFilterEditor('Dobavitelj').Focus();}"
