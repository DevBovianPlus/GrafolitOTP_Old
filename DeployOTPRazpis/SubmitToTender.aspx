    ...
    <script type="text/javascript">
        ...
        function CallbackPanel_EndCallback(s, e) {
            ...
            if (s.cpNoQueryStringError != null && s.cpNoQueryStringError !== undefined) {
                ...
                ShowWarningPopUp("Napačna zahteva", "Poslana zahteva ne ustreza!");
                ...
                ShowWarningPopUp("Napačna zahteva", "Poslana zahteva ne ustreza predvideni!");
                ...
                ShowWarningPopUp("Prijava potekla!", "Žal je prijava za izbrano relacijo potekla.");
            ...
            <dx:PanelContent>
                <div class="container-fluid p-0">
                    <div class="banner overlay">
                        ...
                        <h1>Prijava prevoznika
                <br />
                            <small>Premagajte konkurenco</small>
                        </h1>
                    </div>
...
Opozarjamo, da z oddajo cene, jamčite za ceno in se obvežete, da boste zagotovili prevoz na zapisani relaciji in na zapisan datum (DATUM NAKLADA), v kolikor boste izbrani za prevoz.
                            ...
                            <div class="col-lg-7">
                                 <div class="row mb-4">
                                    <div class="col-lg-12">
                                        <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="ŠT. ODPOKLICA" />
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-12">
                                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="RELACIJA" />
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-12">
                                        <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="PODATKI O BLAGU" />
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-6">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="DATUM NAKLADA" />
                                    ...
                                    <div class="col-lg-6">
                                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="PREDLAGANA CENA" />
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-5">
                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="PRIJAVNA CENA" />
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row d-flex align-items-center">
                                            ...
                                            <div class="col-11 pl-0">
                                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="STRINJAM SE S POGOJI PRIJAVE" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-4">
                                        <dx:ASPxButton ID="btnSubmitPrice" runat="server" ForeColor="#007bff" UseSubmitBehavior="false" AutoPostBack="false" Text="Oddaj ceno"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Pogoji prijave</h4>
                                <p class="card-text">Opozarjamo, da z oddajo cene, jamčite za ceno in se obvežete, da boste zagotovili prevoz na zapisani relaciji in na zapisan datum (DATUM NAKLADA), v kolikor boste izbrani za prevoz.</p>
