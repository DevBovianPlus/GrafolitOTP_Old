...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid p-0">
        <div class="banner overlay">
            ...
            <h1>Vaša cena je bila uspešno posredovana</h1>
        </div>
        <div class="container mt-5">
            <div class="jumbotron">
                <h1 class="display-4">Hvala za vašo prijavo!</h1>
                <p class="lead">Vaša cena je bila uspešno shranjena. O prevozu Vas bomo obvestili najmanj 3 dni pred datumom naklada.</p>
                <hr class="my-4">
