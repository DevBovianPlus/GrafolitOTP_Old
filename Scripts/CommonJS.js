...
FocusClearValidationIfAny = function (s, e) {
    var element = s.GetInputElement();

    if ($(element).parent().hasClass("focus-text-box-input-error"))
        $(element).parent().removeClass("focus-text-box-input-error");
    else if ($(element).parent().parent().hasClass("focus-text-box-input-error"))
        $(element).parent().parent().removeClass("focus-text-box-input-error");
    else if ($(element).parent().parent().parent().hasClass("focus-text-box-input-error"))
        $(element).parent().parent().parent().removeClass("focus-text-box-input-error");
}
